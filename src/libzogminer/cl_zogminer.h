...
public:
	...
	static void doForAllDevices(unsigned _platformId, std::function<void(unsigned _plat, unsigned _dev, cl::Device const&)> _callback);
	static void doForAllDevices(std::function<void(unsigned _plat, unsigned _dev, cl::Device const&)> _callback);
