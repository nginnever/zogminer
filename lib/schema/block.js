...
const SchemaTransaction = require('./transaction')
const Transaction = SchemaTransaction.Transaction
const TransactionIn = SchemaTransaction.TransactionIn
const TransactionOut = SchemaTransaction.TransactionOut
const COINBASE_OP = SchemaTransaction.COINBASE_OP


const VerificationError = require('../error').VerificationError
